    ...
    USE [KNSDevDbt];
    EXEC('
        create view "dbt_tlawson_intermediate"."int_sales__FactSalesLine_Deposco__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "KNSDevDbt"."dbt_tlawson_intermediate"."int_sales__FactSalesLine_Deposco" FROM "KNSDevDbt"."dbt_tlawson_intermediate"."int_sales__FactSalesLine_Deposco__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS dbt_tlawson_intermediate.int_sales__FactSalesLine_Deposco__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'dbt_tlawson_intermediate_int_sales__FactSalesLine_Deposco_cci'
        AND object_id=object_id('dbt_tlawson_intermediate_int_sales__FactSalesLine_Deposco')
    )
    DROP index "dbt_tlawson_intermediate"."int_sales__FactSalesLine_Deposco".dbt_tlawson_intermediate_int_sales__FactSalesLine_Deposco_cci
    CREATE CLUSTERED COLUMNSTORE INDEX dbt_tlawson_intermediate_int_sales__FactSalesLine_Deposco_cci
    ON "dbt_tlawson_intermediate"."int_sales__FactSalesLine_Deposco"
