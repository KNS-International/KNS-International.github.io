    ...
    USE [KNSDataWarehouse];
    EXEC('
        create view "Deposco"."DimItem__dbt_tmp__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "KNSDataWarehouse"."Deposco"."DimItem__dbt_tmp" FROM "KNSDataWarehouse"."Deposco"."DimItem__dbt_tmp__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS Deposco.DimItem__dbt_tmp__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'Deposco_DimItem__dbt_tmp_cci'
        AND object_id=object_id('Deposco_DimItem__dbt_tmp')
    )
    DROP index "Deposco"."DimItem__dbt_tmp".Deposco_DimItem__dbt_tmp_cci
    CREATE CLUSTERED COLUMNSTORE INDEX Deposco_DimItem__dbt_tmp_cci
    ON "Deposco"."DimItem__dbt_tmp"
