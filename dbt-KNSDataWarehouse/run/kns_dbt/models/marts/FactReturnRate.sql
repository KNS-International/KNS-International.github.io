    ...
    USE [KNSDevDbt];
    EXEC('
        create view "dbt_prod_marts"."FactReturnRate__dbt_tmp__dbt_tmp_vw" as with
...
EXEC('
            SELECT * INTO "KNSDevDbt"."dbt_prod_marts"."FactReturnRate__dbt_tmp" FROM "KNSDevDbt"."dbt_prod_marts"."FactReturnRate__dbt_tmp__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS dbt_prod_marts.FactReturnRate__dbt_tmp__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'dbt_prod_marts_FactReturnRate__dbt_tmp_cci'
        AND object_id=object_id('dbt_prod_marts_FactReturnRate__dbt_tmp')
    )
    DROP index "dbt_prod_marts"."FactReturnRate__dbt_tmp".dbt_prod_marts_FactReturnRate__dbt_tmp_cci
    CREATE CLUSTERED COLUMNSTORE INDEX dbt_prod_marts_FactReturnRate__dbt_tmp_cci
    ON "dbt_prod_marts"."FactReturnRate__dbt_tmp"
