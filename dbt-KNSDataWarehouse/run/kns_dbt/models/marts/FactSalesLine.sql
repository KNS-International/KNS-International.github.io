...
-- date_cutoff as (
--   select
--     cast(dateadd(day, 1, max(MonthEndAt)) as datetime) as date_cutoff
...
--           and act4.GrossToNetPercentage is null
--           then 0.8
--         when d.date_cutoff < u.ActualShipDate 
--           then coalesce(
--           bud1.GrossToNetPercentage, bud2.GrossToNetPercentage, bud3.GrossToNetPercentage, bud4.GrossToNetPercentage
--         )
--         else coalesce(
--           act1.GrossToNetPercentage, act2.GrossToNetPercentage, act3.GrossToNetPercentage, act4.GrossToNetPercentage, null
--         )
