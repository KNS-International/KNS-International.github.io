    ...
    when matched then update set
        "SourceId" = DBT_INTERNAL_SOURCE."SourceId","SalesOrderId" = DBT_INTERNAL_SOURCE."SalesOrderId","ProductVariantId" = DBT_INTERNAL_SOURCE."ProductVariantId","QuantityOrdered" = DBT_INTERNAL_SOURCE."QuantityOrdered","QuantityShipped" = DBT_INTERNAL_SOURCE."QuantityShipped","QuantityCanceled" = DBT_INTERNAL_SOURCE."QuantityCanceled","UnitCostAmount" = DBT_INTERNAL_SOURCE."UnitCostAmount","UnitItemCOGSAmount" = DBT_INTERNAL_SOURCE."UnitItemCOGSAmount"
    

    when not matched then insert
        ("SourceId", "SalesOrderId", "ProductVariantId", "QuantityOrdered", "QuantityShipped", "QuantityCanceled", "UnitCostAmount", "UnitItemCOGSAmount")
    values
        ("SourceId", "SalesOrderId", "ProductVariantId", "QuantityOrdered", "QuantityShipped", "QuantityCanceled", "UnitCostAmount", "UnitItemCOGSAmount");
